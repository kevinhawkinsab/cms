...
import { notify, alertPermissionDenied } from '~/services/notifications'
...
/* ─── Toast ─── */
.bsw-toast { position: fixed; top: 20px; right: 20px; z-index: 9999; display: flex; align-items: center; gap: 10px; padding: 12px 16px; border-radius: var(--radius-md); background: #fff; border: 1px solid var(--gray-200); box-shadow: 0 4px 24px rgba(0,0,0,.10); min-width: 280px; max-width: 400px; font-size: 13.5px; }
.bsw-toast.success .bsw-toast__icon { color: var(--green-600); }
.bsw-toast.danger  .bsw-toast__icon { color: #dc2626; }
...
/* ─── Cards (sin cambios, mantenidos del original) ─── */
