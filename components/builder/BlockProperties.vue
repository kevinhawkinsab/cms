  ...
  <aside class="block-properties" data-testid="block-properties" v-if="block">
    ...
    <div class="props-body">
      ...
      <template v-if="block.type === 'front-page'">
        ...
        <!-- <div class="prop-group">
          <label class="prop-label">Fecha</label>
          <input class="form-control prop-input" :value="block.content.date" @input="updateContent({ date: $event.target.value })" placeholder="12 de abril de 2026" />
        </div> -->
        <div class="prop-group">
          <label class="prop-label">Autor</label>
