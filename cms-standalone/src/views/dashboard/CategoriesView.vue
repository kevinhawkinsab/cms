...
.posts-count-badge--active { background: var(--green-50); color: var(--green-800); border: 1px solid rgba(37,99,235,.15); }
...
.field-input:focus { border-color: var(--green-700); box-shadow: 0 0 0 3px rgba(37,99,235,.08); }
